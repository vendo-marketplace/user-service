...
//        SecurityContext securityContext = SecurityContextUtils.initializeSecurityContext(mongoUser);
//
...
//        MongoUser mongoUser = UserDataBuilder.buildUserAllFields()
//                .status(UserStatus.ACTIVE)
//                .emailVerified(true)
//                .build();
//        userRepository.save(mongoUser);
//        String accessToken = testJwtService.generateAccessToken(mongoUser);
//
...
//        MongoUser mongoUser = UserDataBuilder.buildUserAllFields().build();
//        userRepository.save(mongoUser);
//        String expiredToken = testJwtService.generateTokenWithExpiration(mongoUser, 0);
//
